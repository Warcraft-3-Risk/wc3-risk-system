...
```mermaid
pie title City Distribution by Country Size
    "1-city countries (5)" : 5
    "2-city countries (35)" : 35
    "3-city countries (16)" : 16
    "4-city countries (10)" : 10
    "5-city countries (7)" : 7
    "6-city countries (2)" : 2
    "7-city countries (1)" : 1
    "8-city countries (1)" : 1
```
...
```mermaid
flowchart TD
    World["World Map<br/>212 Countries, 555 Cities"]
    World --> NA["North America"]
    World --> SA["South America"]
    World --> EU["Europe"]
    World --> AF["Africa"]
    World --> AS["Asia"]
    World --> OC["Oceania/Pacific"]
    World --> AN["Antarctica"]
```
...
```mermaid
flowchart TD
    Build["Build System"] --> Config["MAP_TYPE variable"]
    Config --> Switch{MAP_TYPE}
    Switch -- 'europe' --> EU[Load Europe Terrain]
    Switch -- 'asia' --> AS[Load Asia Terrain]
    Switch -- 'world' --> WD[Load World Terrain]
```
