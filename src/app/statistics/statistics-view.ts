...
export class StatisticsView {
    ...
    private static readonly PINNED_COLUMNS: number = 2;
    ...
    constructor(model: StatisticsModel) {
        ...
        this.page = new StatisticsPage(
            this.model, 
            this.pageIndicator, 
            StatisticsView.COLUMNS_PER_PAGE, 
            StatisticsView.PINNED_COLUMNS,
    ...
    private updateColumnVisibility(): void {
        let headerX = this.columns[1] ? BlzFrameGetWidth(this.columns[0]) + BlzFrameGetWidth(this.columns[1]) + 0.008 : 0.008;
    ...
    private setupPaginationUI(): void {
        ...
        this.leftButton = this.CreateFooterButton(
            this.footerBackdrop, 
            'LeftFooterButton', 
            'Previous', 
            -0.1, 
        ...
        this.rightButton = this.CreateFooterButton(
            this.footerBackdrop, 
            'RightFooterButton', 
            'Next', 
            0.1, 
