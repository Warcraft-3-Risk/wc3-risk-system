...
import { getParticipantNamePrefixedWithTeamNumber } from '../utils/participant-entity';
	...
	return [
		{
			size: 0.11,
			header: 'Player Names',
			textFunction: (player) => getParticipantNamePrefixedWithTeamNumber(player.getPlayer()),
		},
		{
			size: 0.04,
			header: 'Rank',
